...
router
  ...
  .post(
    ...
    [
      ...
      body("category").not().isEmpty().withMessage("Select a category"),
    ],
  ...
  .put(
    ...
    adminController.updatePhotoBySlug
  );
router.route("/photos/edit/:slug").get(adminController.editPhotoBySlug);
router
  .route("/photos/:slug")
  .delete(authMiddleware, adminController.deletePhoto);

/***** Categories *****/
router.route("/categories").get(authMiddleware, adminController.listCategories);
router
  .route("/categories/add")
  .get(authMiddleware, adminController.addCategoryForm);
...
router
  ...
  .get(authMiddleware, adminController.editCategoryForm);
...
router
  ...
  .delete(authMiddleware, adminController.deleteCategory);

/***** Tags *****/
router.route("/tags").get(authMiddleware, adminController.listTags);
router
  .route("/tags/edit/:slug")
  .get(authMiddleware, adminController.tagEditForm);
